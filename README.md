...
<h2>홈페이지 주요 내용</h2>
<ul>
  <li>환자 - 병원 통합 예약.(야놀자의 병원화)</li>
  <li>환자 - 건강기록부 및 CT / MRI / X-Ray 업로드 기능</li>
  <li>환자 - 건강기록부에 한하여, AI(Cluade Sonnet)가 요약을 하고, 식습관 및 운동을 추천함. 더불어 혈압 / 혈당 / 감마지티피(간수치)에 한하여 내 나이 평균에 비해 얼마나 상태가 좋고 나쁜지를 백분율로 표기함.</li>
  <li>병원(의사) - 환자의 예약 관리 시스템</li>
  <li>병원(의사) - 환자가 업로드한 건강기록부 및 CT / MRI / X-Ray사진 열람 기능</li>
</ul>
<br/>
<h3>🛠️ Tech Stack</h3>
<ul>
